      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 mt-4">
        ...
        <div className="space-y-8">
          {locations.map((location) => (
            <div key={location.id} className="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-[#E7BD8B] transform hover:scale-[1.02] transition-all duration-300">
              {/* Map Placeholder */}
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="inline-block bg-white rounded-full p-6 shadow-lg mb-4">
                      <svg className="w-16 h-16 text-[#234433]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="p-8">
                <div className="flex items-start space-x-4 mb-6">
                  <div className="bg-[#234433]/10 p-3 rounded-full flex-shrink-0">
                    <svg className="w-6 h-6 text-[#234433]" fill="currentColor" viewBox="0 0 20 20">
