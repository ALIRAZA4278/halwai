      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mb-8">
          <h2 className="text-4xl font-bold text-gray-800 mb-4 font-serif">
            halwai is a name synonymous with<br />
            taste, tradition, and trust.
          </h2>
          
          <div className="max-w-3xl mx-auto text-gray-700 leading-relaxed space-y-4">
            <p>
              From our signature mithai boxes that celebrate every occasion, to indulgent desserts, freshly baked cakes, crispy nimco, savory snacks, and even 
        ...
        <div className="border-t border-gray-300 pt-6">
          <div className="flex flex-wrap justify-center items-center space-x-2 text-sm text-gray-600">
            <span>Powered by</span>
            <a href="#" className="text-blue-600 hover:underline font-medium">Indolj</a>
            <span>|</span>
            <a href="#" className="hover:text-gray-800 transition-colors">Privacy Policy</a>
            <span>|</span>
            <a href="#" className="hover:text-gray-800 transition-colors">Faqs</a>
            <span>|</span>
            <a href="#" className="hover:text-gray-800 transition-colors">Our Locations</a>
          </div>
        </div>
      </div>
